...
%% Match Features
matches1 = matchFeatures(fHM1, fHM2, cornersHM1.coordinates, cornersHM2.coordinates, 8, 200000, 4/5);
...
matches2 = matchFeatures(fHM1, fHM2, cornersHM1.coordinates, cornersHM2.coordinates, 10, 200000, 4/5);

% Visualize matchet points with interconnections
figure;showMatchedFeatures(fHM1,fHM2,[matches2(:,3), matches2(:,2)],[matches2(:,5), matches2(:,4)],'montage','Parent',axes);

matches3 = matchFeatures(fHM1, fHM2, cornersHM1.coordinates, cornersHM2.coordinates, 12, 200000, 4/5);

% Visualize matchet points with interconnections
figure;showMatchedFeatures(fHM1,fHM2,[matches3(:,3), matches3(:,2)],[matches3(:,5), matches3(:,4)],'montage','Parent',axes);

matches4 = matchFeatures(fHM1, fHM2, cornersHM1.coordinates, cornersHM2.coordinates, 14, 200000, 4/5);

% Visualize matchet points with interconnections
figure;showMatchedFeatures(fHM1,fHM2,[matches4(:,3), matches4(:,2)],[matches4(:,5), matches4(:,4)],'montage','Parent',axes);

matches5 = matchFeatures(fHM1, fHM2, cornersHM1.coordinates, cornersHM2.coordinates, 16, 200000, 4/5);
